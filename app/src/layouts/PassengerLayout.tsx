...
const NAV = [
  { to: '/passenger/book',    label: 'Book a ride', icon: 'plus' as const },
  { to: '/passenger/active',  label: 'Active trip', icon: 'route' as const },
  { to: '/passenger/history', label: 'History',     icon: 'history' as const },
];
      ...
      <header className="flex items-center justify-between px-4 sm:px-6 py-3 bg-ink text-paper">
        <div className="flex items-center gap-4">
          ...
          <span className="hidden md:inline-flex items-center gap-2 font-mono text-[11px] tracking-widest uppercase text-white/60">
            <span className="w-1.5 h-1.5 rounded-full bg-[#7FD49B]" /> Passenger
          </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 pl-3 border-l border-white/10">
            <div className="sr-avatar sr-avatar--sm" style={{ background: 'var(--sr-accent)', color: 'white' }}>{initials}</div>
